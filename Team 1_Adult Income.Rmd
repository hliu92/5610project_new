...
plot(residuals.glm(fit.int7,type="pearson")[1:5000])
```
...
plot(income_trial$ID[income_trial$marital_new=="Married"],
     residuals.glm(fit.int7,type="pearson")[income_trial$marital_new=="Married"],xlim=c(1,30000),ylim=c(-10,10),col=2)
par(new=TRUE)
plot(income_trial$ID[income_trial$marital_new=="Alone"],
     residuals.glm(fit.int7,type="pearson")[income_trial$marital_new=="Alone"],xlim=c(1,30000), ylim=c(-10,10),col=4)
```
