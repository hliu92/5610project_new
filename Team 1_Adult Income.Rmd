...
# divide into 5 categories: 0 as the first category, and all others by quartile
library(gtools)
cg_quartile <- quantcut(income$capital_gain[income$capital_gain>0])
table(cg_quartile)
income_rec$capital_gain_cat <- cut(income_rec$capital_gain, 
                       breaks = c(-Inf, 114, 3.46e+03, 7.3e+03, 1.41e+04, Inf), 
                       labels = c("zero", "non-zero quar 1", "non-zero quar 2", "non-zero quar 3", "non-zero quar 4"), 
                       right = FALSE)
